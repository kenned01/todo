    ...
    return (
      <div className="todo-c">
          <div className="container">
            <ItemInput onEnter={this.onEnter.bind(this)} />
            <ListItem items={displayItems} onDelete={this.onDelete.bind(this)} onComplete={this.onComplete.bind(this)} />
            <TabBar onFilter={this.onFilter.bind(this)}/>
          </div>
      </div>
    );
  }
